...
//
 ...
 const recursionPattern = (int1, int2, currant = int1, increase = false, arr =[]) => {
...
arr.push(currant);
  ...
  recursionPattern(int1, int2,currant, increase, arr);
...
const isPalindrome = (str) => {
    ...
    const cleanedUp = str.replace(/[^a-z0-9]/gi, '').toLowerCase();
